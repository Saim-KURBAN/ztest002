		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ZTEST 002",
									"targetURL": "#comsaimkurbanztest002ztest002-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaimkurbanztest002ztest002-display": {
								"semanticObject": "comsaimkurbanztest002ztest002",
								"action": "display",
								"description": "ZTEST 002",
								"title": "ZTEST 002",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.saimkurban.ztest002.ztest002",
									"url": sap.ui.require.toUrl("com/saimkurban/ztest002/ztest002")
								}
							}
						}
					}
